...
//oracle address : 0x26B39Cc83AdEe8dE1F5CE37b06E43763650886bD
    function nearRealTimeValue(address _addr) public view returns (uint){
        ExampleContract callee = ExampleContract(_addr);
        z = callee.getX();
        return z;
    }

    function realTimeValue(address _addr, uint _x) public payable {
        ExampleContract callee = ExampleContract(_addr);
        (a, b) = callee.updatePrice.value(msg.value)(_x);
    }
}
